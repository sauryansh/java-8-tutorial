...
public class StudentDatabase {
    ...
    public static List<Student> getAllStudentDetails() {
        ...
        Student student2 = new Student("Jenny",2,3.8,"female", Arrays.asList("swimming","gymnastic","soccer"),12);
        /**
         * 3rd grade students
         */
        Student student3 = new Student("Emily",3,4.0,"female", Arrays.asList("swimming","basketball","aerobics"),10);
        Student student4 = new Student("Dave",3,3.9,"male", Arrays.asList("swimming","gymnastic","soccer"),9);
        /**
         * 4th grade students
         */
        Student student5 = new Student("Sophia",4,3.5,"female", Arrays.asList("swimming","dancing","football"),15);
        Student student6 = new Student("James",4,3.9,"male", Arrays.asList("swimming","basketball","baseball","soccer"),14);

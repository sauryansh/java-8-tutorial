...
public class StudentDatabase {
    ...
    public static List<Student> getAllStudentDetails() {
        ...
        Student student2 = new Student("Jenny",2,3.8,"female", Arrays.asList("swimming","gymnastic","soccer"));
        /**
         * 3rd grade students
         */
        ...
        Student student6 = new Student("James",4,3.9,"male", Arrays.asList("swimming","basketball","baseball","soccer"));
